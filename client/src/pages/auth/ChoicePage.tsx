                    ...
                    {users.map((user, index) => {
                        if("abonnementsRue" in user) {
                            ...
                            return <div className={`col-12 d-flex align-items-center justify-content-center col-lg-4`}>
                                <MyLink key={index} to="/dashboard" onClick={() => {handleInfos(resident)}} className={`mycard1 orange text-white rounded-4 p-3 m-5 border `}>
                            ...
                            return <div className={`col-12 d-flex align-items-center justify-content-center col-lg-4`}>
                                <MyLink to="/dashboard" onClick={() => {handleInfos(prestataire)}} className={`mycard1 orange text-white rounded-4 p-3 m-5 border`}>
