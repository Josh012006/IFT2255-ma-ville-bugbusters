    ...
    return (
        <div>
            ...
            <div className="d-flex flex-column flex-lg-row justify-content-around align-items-center my-5">
                <MyLink to="/resident/signalement/new" className="mycard3 orange text-white rounded-4 p-3 m-5 border d-flex align-items-center justify-content-center">
                    <img width="50" src="/new.png" alt="nouveau signalement" />
                    <h6 className="mx-3">Faire un nouveau signalement</h6>
                </MyLink>
                <MyLink to="/resident/signalement/list" className="mycard3 orange text-white rounded-4 p-3 m-5 d-flex border align-items-center justify-content-center">
