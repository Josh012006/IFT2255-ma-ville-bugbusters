...
public class ResidentDAO {
    ...
    // Todo: Une méthode findToNotify(String quartier, String rue) qui renvoie tous les résidents
    //  de la base de données qui ont le quartier présent dans leur liste de quartiers auxquels ils osnt interessés
    //  ou bien la rue présente dans leur liste de rues auxquelles ils sont abonnés.
